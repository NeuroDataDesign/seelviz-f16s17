                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2 text-center">
                            ...
                            <hr class="light">
                            <p class="text-faded">Either upload a Nifti file or type in the name of the token as it appears on NDStore. Afterwards, sit back and relax - Clarityviz will take care of the rest.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2 text-center">
                            ...
                            <hr class="primary">
                            <p>Ready to start your next project with us? Send us an email and we will get back to you as soon as possible!</p>
                        </div>
                        </div>
                        <div class="col-lg-4 text-center">
                            <i class="fa fa-envelope-o fa-3x sr-contact"></i>
                            <p><a href="mailto:your-email@your-domain.com">clviz@neurodata.io</a></p>
                        </div>
                    </div>
                </div>
            </section>
